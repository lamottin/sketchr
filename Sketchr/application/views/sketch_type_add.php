		...
		<div class="row">
			<form method="post" action="<?php echo base_url(); ?>sketchtype/add/">
				<div class="large-8 columns">
					...
					echo "<input type=\"text\" name=\"title\" placeholder=\"Type the title here\" value=\"" .set_value('title')."\" class=\"required\" id=\"title\"/>";	
					...
					echo "<input type=\"text\" name=\"start_date\" placeholder=\"Please select a start date\" value=\"".set_value('start_date') ."\" class=\"datepicker required\" id=\"start_date\"/>";
					...
					echo "<input type=\"text\" name=\"image\" placeholder=\"Type the URL here\" value=\"". set_value('image') ."\" class=\"required\" id=\"image\"/>";
					...
					echo "<textarea rows=\"5\" name=\"synopsis\" class=\"required\" id=\"synopsis\">"; $value = set_value('synopsis'); $value = (!empty($value)) ? $value : "Type the synopsis here"; $value .= "</textarea>";
					...
					$select_humorists = "<select name=\"humorist\" style=\"height: 100px;\" multiple=\"multiple\" class=\"required\">";
						foreach($humorists as $humorist):
							$select_humorists .= "<option value=\"". $humorist->id ."\">". $humorist->first_name ." ".$humorist->last_name ."</option>";								
						endforeach;
